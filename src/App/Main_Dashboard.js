    ...
    <div id="container">
      <nav id="navbar">
        ...
        <ul>
          ...
          <li>
            <Link to="/login/Main_Dashboard/Requests" className="shortcut">Notification</Link>
          </li>
          <li>
            <Link to="/login/Main_Dashboard/My_Request" className="shortcut">RequestStatus</Link>
          </li>
          <li>
      ...
      <section className="spread show hello">
